...
contract("zkPoDExchange", async (accounts) => {
    ...
    it("should submitProofComplaint correctly (for not evil)", async () => {
        ...
        let hash = web3.utils.soliditySha3({ t: 'uint256', v: _sessionId }, { t: 'address', v: _from }, { t: 'address', v: _to }, { t: 'bytes32', v: _bltKey }, { t: 'bytes32', v: _seed2 }, { t: 'bytes32', v: _k_mkl_root }, { t: 'uint64', v: _count }, { t: 'uint256', v: _price }, { t: 'uint256', v: _expireAt });
        ...
        // session record
        let _result = await zkPoDEX.submitProofComplaint(_seed0, _sessionId, [_from, _to], _bltKey, _seed2, _k_mkl_root, _count, _price, _expireAt, signature, {from: alice});
        ...
        await truffleAssert.reverts(
            zkPoDEX.submitProofComplaint(_seed0, _sessionId, [_from, _to], _bltKey, _seed2, _k_mkl_root, _count, _price, _expireAt, signature, {from: alice})
        );
    });
    ...
    it("should submitProofComplaint correctly (for evil)", async () => {
        ...
        await zkPoDEX.submitProofComplaint(_seed0, _sessionId, [_from, _to], _bltKey, _seed2, _k_mkl_root, _count, _price, _expireAt, signature, { from: alice });
    ...
    it("should submitProofAtomicSwap correctly (not evil)", async () => {
        ...
        let hash = web3.utils.soliditySha3({ t: 'uint256', v: _sessionId }, { t: 'address', v: _from }, { t: 'address', v: _to }, { t: 'bytes32', v: _seed2 }, { t: 'uint256', v: _sigma_vw }, { t: 'uint64', v: _count }, { t: 'uint256', v: _price }, { t: 'uint256', v: _expireAt });
        let signature = await web3.eth.sign(hash, bob);

        await zkPoDEX.submitProofAtomicSwap(_seed0, _sCnt, _sessionId, [_from, _to], _seed2, _sigma_vw, _count, _price, _expireAt, signature, { from: alice })

        await truffleAssert.reverts(zkPoDEX.submitProofAtomicSwap(_seed0, _sCnt, _sessionId, [_from, _to], _seed2, _sigma_vw, _count, _price, _expireAt, signature, { from: alice }), "not new")
    });
